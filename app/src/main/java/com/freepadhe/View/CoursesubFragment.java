...
import com.freepadhe.Adapter.CoursesublistAdapter;
import com.freepadhe.GsonModel.CourseDatum;
...
import com.freepadhe.databinding.FragmentCoursesubBinding;
...
public class CoursesubFragment extends Fragment implements OnclickListener {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*mbinding.liveVideoCourse.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mbinding.tvReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((mCourseDatum != null)) {
                    intent.putExtra("class_name", mCourseDatum.getName());
                    intent.putExtra("class_reviews", mCourseDatum.getRating());
                }
                startActivity(intent);
            }
        });
